...
import dateConverter from './modules/time-formatter';
...
const distanceInCentimeters = distanceConverter.conversion(distanceInInchesFromHTML);
const currentTime = dateConverter;
